...
import { DEFECT_TYPE_LABELS, DEFECT_TYPE_COLORS, SEVERITY_LABELS } from '../types';
import type { DefectType, Severity } from '../types';

export default function StatisticsPanel() {
  const { state, plateAnnotations, selectedPlate } = useApp();
  ...
  return (
    <div style={{ padding: 16, overflow: 'auto', height: '100%' }}>
      ...
      <Card size="small" title={<span style={{ fontSize: 13 }}>缺陷类型说明</span>} style={{ marginTop: 12 }}>
